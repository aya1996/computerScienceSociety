            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">صور السلايدر</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            <h4 class="m-t-0 header-title mb-4"><b>صور السلايدر</b></h4>
                                    ...
                                    @if ($sliders->count() > 0)
                                        @foreach ($sliders as $key => $slider)
                                            <tr>
                                                ...
                                                <td class="text-center">{!! \Illuminate\Support\Str::limit($slider->description, 50, '') !!}</td>
                                                <td class="text-center">
                                                    <img src="{{asset($slider->image)}}" style="width: 50px; height: 50px; border-radius: 50%">
                                                </td>
                                                <td class="text-center">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <form class="parsley-examples" method="POST" action="{{route('sliders.store')}}" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
