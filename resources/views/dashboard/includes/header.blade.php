...
<head>
        ...
        <link href="{{asset('dashboard/libs/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('dashboard/libs/datatables/buttons.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('dashboard/libs/datatables/responsive.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{asset('dashboard/libs/custombox/custombox.min.css')}}" rel="stylesheet" type="text/css">
