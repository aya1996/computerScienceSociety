                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            <h4 class="m-t-0 header-title mb-4"><b>الكليات</b></h4>
                                        ...
                                        @foreach ($colleges as $key => $college)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{asset($college->image)}}" style="width: 50px; height: 50px; border-radius: 50%">
                                                </td>
                                                <td class="text-center">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{route('colleges.destroy' ,$college->id )}}" method="POST" enctype="multipart/form-data" id="userForm">
                                                                        @csrf
                                                                        @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <form class="parsley-examples" method="POST" action="{{route('colleges.store')}}" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
